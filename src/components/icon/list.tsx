...
export const IconList: IconListObject = {
  facebook: {
    ...
    color: "#0076FB",
    e: (urlOpener, l) => urlOpener(`https://www.facebook.com/sharer/sharer.php?u=${l}`),
  },
  twitter: {
    path: (
    ...
    color: "#000000",
    e: (urlOpener, l, t) =>
      urlOpener(`https://twitter.com/intent/tweet?text=${t}&url=${l}`),
  },
  whatsapp: {
    path: (
    ...
    color: "#25D366",
    e: (urlOpener, l, t) => urlOpener(`https://api.whatsapp.com/send?text=${t} ${l}`),
  },
  reddit: {
    path: (
    ...
    color: "#FF4500",
    e: (urlOpener, l, t) =>
      urlOpener(`https://www.reddit.com/submit?url=${l}&title=${t}`),
  },
  telegram: {
    path: (
    ...
    color: "#0088CC",
    e: (urlOpener, l, t) =>
      urlOpener(`https://telegram.me/share/msg?url=${l}&text=${t}`),
  },
  linkedin: {
    path: (
  ...
  mail: {
    ...
    color: "#E53E3E",
    e: (urlOpener, l, t) => urlOpener(`mailto:?body=${l}&subject=${t}`),
  },
  copy: {
    path: (
    ...
    color: "#718096",
    e: (_ ,l) => navigator.clipboard.writeText(decodeURIComponent(l)),
  },
  vk: {
    path: (
    ...
    color: "#07f",
    e: (urlOpener, l, t, ti) =>
      urlOpener(`http://vk.com/share.php?url=${l}&title=${ti}&comment=${t}`),
  },
  okru: {
    path: (
